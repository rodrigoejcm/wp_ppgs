...
<?php
$args_evento = array( 'post_type' => 'producao',  'categoria_producao' => 'dissertacao' ,'posts_per_page' => 5 );
$loop_evento = new WP_Query( $args_evento );
while ( $loop_evento->have_posts() ) : $loop_evento->the_post(); ?>

<div class="row">
    <div class="col-md-4">
        <div class="ppgs-producao-img" style="background-image: url(<?php echo get_the_post_thumbnail_url() ?> )">
        </div>
    </div>
    <div class="col-md-6">
            <?php //the_category(', ') ?>
